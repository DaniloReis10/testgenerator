...
public class DisciplinaDao {
     ...
     */
    public Disciplina getObject(Connection conn, int id) throws NotFoundException, SQLException {
     ...
     */
    public void load(Connection conn, Disciplina valueObject) throws NotFoundException, SQLException {
     ...
     */
    public synchronized void create(Connection conn, Disciplina valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO Disciplina ( id, nome) VALUES (?, ?) ";
               stmt = conn.prepareStatement(sql);
     ...
     */
    public List searchMatching(Connection conn, Disciplina valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM Disciplina WHERE 1=1 ");
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, Disciplina valueObject) 
          throws NotFoundException, SQLException {
